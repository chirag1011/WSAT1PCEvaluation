...
public class RestaurantParticipant implements Durable2PCParticipant,_1PCParticipant, Serializable {
    ...
    public void commit() throws WrongStateException, SystemException {
       ...
       // System.out.println("[SERVICE] all participants voted 'prepared', so coordinator tells the participant to commit");
    	System.out.println("RestaurantParticipant [SERVICE]---------------transaction is about to commit-------------");
