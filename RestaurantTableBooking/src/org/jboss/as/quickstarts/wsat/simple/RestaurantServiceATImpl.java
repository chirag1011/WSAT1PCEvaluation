...
public class RestaurantServiceATImpl implements RestaurantServiceAT {
     ...
     */
    @WebMethod
    public void makeBooking(String protocolType) throws RestaurantException {
        ...
        try {
            ...
            System.out.println("RestaurantServiceATImpl.makeBooking()");
            if("2PC".equalsIgnoreCase(protocolType))
            	...
            	transactionManager.enlistForOnePhase(restaurantParticipant, "restaurantServiceAT:" + UUID.randomUUID());
        } catch (Exception e) {
