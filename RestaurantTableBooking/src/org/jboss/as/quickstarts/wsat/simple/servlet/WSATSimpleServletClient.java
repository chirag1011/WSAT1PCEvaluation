...
public class WSATSimpleServletClient extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("WSATSimpleServletClient.doGet()------------------Step 1");
        System.out.println("WSATSimpleServletClient.doGet()--------bindingProvider-------"+bindingProvider);
        ...
        long startTime = 0;
        long stopTime = 0;
        System.out.println("WSATSimpleServletClient.doGet()-------ut object-------"+ut);
        try {
            System.out
            ...
            for(int i=0;i<100;i++){
	            ...
	            //client.makeBooking("2PC");
	            
	            client.makeBooking("1PC");
