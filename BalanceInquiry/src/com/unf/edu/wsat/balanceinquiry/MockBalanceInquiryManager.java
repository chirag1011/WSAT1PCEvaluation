 ...
 *
 */
public class MockBalanceInquiryManager {

    // The singleton instance of this class.
    private static MockBalanceInquiryManager singletonInstance;
     ...
     */
    public synchronized static MockBalanceInquiryManager getSingletonInstance() {
        if (singletonInstance == null) {
            singletonInstance = new MockBalanceInquiryManager();
        }
     ...
     */
    public synchronized long getBalance(Object txID) {
        System.out.println("[SERVICE] getBalance called on backend resource.");
